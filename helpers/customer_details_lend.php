...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $conn->query("UPDATE customers SET loan = loan + $amount WHERE id = $customer_id");
    // update the customers_loan_log
    $conn->query("INSERT INTO customer_loans_log (customer_id, amount, repay_lend, username) VALUES ($customer_id, $amount, 'lend', '$user')");
    // subtract money from drawer
